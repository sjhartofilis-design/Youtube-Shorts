...
const defaultSettings: SettingsState = {
  ...
  youtubeClientId: '',
  youtubeClientSecret: '',
  youtubeAccessTokenSpace: '',
  youtubeRefreshTokenSpace: '',
  youtubeTokenExpiresAtSpace: 0,
  youtubeChannelNameSpace: '',
  youtubeChannelPicSpace: '',
  youtubeAccessTokenAncientCiv: '',
  youtubeRefreshTokenAncientCiv: '',
  youtubeTokenExpiresAtAncientCiv: 0,
  youtubeChannelNameAncientCiv: '',
  youtubeChannelPicAncientCiv: '',
